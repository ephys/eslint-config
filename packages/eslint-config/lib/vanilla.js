        ...
        'error',
        {
          ...
          patterns: [
            ...
            },
            {
              group: ['lodash/omitBy*'],
              message:
                'Use omitByValue from the @sequelize/utils package instead if possible.',
            },
            {
            ...
            },
            {
              ...
              message:
                'Please use assert from @sequelize/utils, as it works in all envs',
            },
          ],
        },
      ],
...
Trying to check whether a global exists? Use 'globalThis.<globalName>'`,
...

        {
          ...
          message:
            'Avoid double negations: !isNotXxx() is not allowed, use isXxx() instead',
        },
        ...
        {
          selector:
            'ObjectExpression:not(:has(Property)):not(:has(SpreadElement))',
...
Note that "new Date()" without arguments is still allowed to get the current DateTimeOffset.`,
        },
        {
          ...
          message:
            'Always specify the locale to use when using toLocaleX methods.',
        },
        {
          selector:
        ...
        },
        {
          ...
          message:
            '.catch is incorrectly typed as any. Type it explicitly as unknown instead.',
        },
      ],
